...
export default function PaymentsPage() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", flex: 1 }}>
      ...
      >
        {/* Overview section — no shared white wrapper */}
        <div>
          <div
            className="pay-overview-header"
          ...
          <div className="pay-stat-cards">
            <StatCard
              ...
              value={fmt(b?.paystackBalance)}
              loading={loading}
            />
            <StatCard
              label="Korapay Balance"
              value={fmt(b?.korapayBalance)}
              loading={loading}
            />
            <StatCard
              label="Paystack Escrow"
              value={fmt(b?.paystackEscrowsBalance)}
              loading={loading}
            />
            <StatCard
              label="Korapay Escrow"
              value={fmt(b?.korapayEscrowsBalance)}
              loading={loading}
            />
          </div>
        </div>
