                ...
                <tbody className="divide-y divide-border">
                  {agent.recruitedExperts.map((expert, i) => (
                    <tr key={i} className="hover:bg-background transition-colors">
                      <td className="py-3.5 text-[13.5px] text-text-main pr-8">{expert.name}</td>
                      <td className="py-3.5 text-[13.5px] text-text-muted pr-8">{expert.earningsHistory}</td>
                      <td className="py-3.5 pr-8"><AgentBadge status={expert.subTas} /></td>
                      <td className="py-3.5 text-[13.5px] text-text-main pr-8">{expert.payouts}</td>
                      <td className="py-3.5 text-[13.5px] text-text-muted">{expert.notes}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
